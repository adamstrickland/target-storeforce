...
PATCH_SFTP = "bonobos_singer_support.sftp.Connection.put_file"

DATA_FILE_NAME = "empty_file.csv"


@pytest.fixture
def path_to_file():
    path = f"./test/fixtures/{DATA_FILE_NAME}"
...
def test_target_output_state_to_stream(basic_config):
    state = {}

    with patch("sys.stdout", new=io.StringIO()) as stdout:
        Target(basic_config).output_state_to_stream([state], stdout)
